...
- Elementwise operations **create new tensors**: `.triu()` (helps create a causal attention mask), `.pow(2)`, `.sqrt()`, `.sqr()`, etc.
...
- A100 has a peak performance of **312e12** FLOP/s (**312** teraFLOP/s); performance for `fp32`
- H100 has a peak performance of **1979e12** FLOP/s with sparsity, **~50%** - -without; performance for `fp16` Tensor cores
- RTX5090 is harder to evaluate due to lack of official reports. But following community publications, we can assume that a peak performance for `fp16` Tensor cores is higher than **104e12** FLOP/s and lower than **1676e12**
...
**Example Calculation**: To train **GPT-4** model it is required `2e25 / (1979e12 * 0.5) / (60 * 60 * 24) ~ 2.34e5` **H100 days**.
...
- RTX5090 [[spec](https://www.nvidia.com/en-us/geforce/graphics-cards/50-series/rtx-5090/); [blog1](https://www.techpowerup.com/gpu-specs/geforce-rtx-5090.c4216); [blog2](https://www.pugetsystems.com/labs/articles/nvidia-geforce-rtx-5090-amp-5080-ai-review/); [blog3](https://boxx.com/blog/hardware/nvidia-geforce-rtx-5090-vs-rtx-4090)]
